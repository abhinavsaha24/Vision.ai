...
class LSTMPredictor:
    ...
    def fit(self, X: np.ndarray, y: np.ndarray):
        ...
        self.model = _LSTMNet(n_feat, self.hidden_size, self.num_layers, self.dropout).to(self.device)
        ...
        for epoch in range(self.epochs):
            ...
            with torch.no_grad():
                ...
                val_loss = criterion(val_pred, torch.tensor(y_val).to(self.device)).item()
