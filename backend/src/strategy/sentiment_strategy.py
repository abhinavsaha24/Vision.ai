...
class SentimentStrategy:
    ...
    def __init__(self, bullish_threshold: float = 0.3,
    ...
    def generate_signal(self, sentiment_data: dict = None, **kwargs) -> int:
        ...
        try:
            ...
            logger.error(f"SentimentStrategy error: {e}")
            return 0
    ...
    def compute_sentiment_features(self, sentiment_data: dict) -> Dict:
        ...
        return {
            ...
            "sentiment_direction": "bullish" if composite > 0 else "bearish" if composite < 0 else "neutral",
        }
