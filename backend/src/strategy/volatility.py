...
class VolatilityBreakoutStrategy:
    ...
    def __init__(self, entry_period: int = 20, exit_period: int = 10,
                 atr_period: int = 20, atr_multiplier: float = 2.0,
    ...
    def generate_signal(self, df: pd.DataFrame = None, **kwargs) -> int:
        ...
        try:
            ...
            logger.error(f"VolatilityBreakoutStrategy error: {e}")
            return 0

    def compute_position_size(self, capital: float, atr: float,
                              contract_value: float = 1.0) -> float:
        """
...
class VolatilityCompressionStrategy:
    ...
    def __init__(self, squeeze_threshold: float = 1.1,
                 lookback: int = 20, momentum_bars: int = 5):
    ...
    def generate_signal(self, df: pd.DataFrame = None, **kwargs) -> int:
        ...
        try:
            ...
            logger.error(f"VolatilityCompressionStrategy error: {e}")
            return 0
