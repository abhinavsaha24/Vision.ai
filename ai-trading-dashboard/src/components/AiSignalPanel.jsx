...
export default function AiSignalPanel({ signalData, loading }) {
  ...
  // Fallback defaults if values are missing or malformed
  const safeConfidence = Number(confidence) || 0;
  const safePositionSize = Number(position_size) || 0;
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <div className={`text-4xl font-black tracking-widest ${color}`}>{displaySignal}</div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-dark-bg border border-dark-border rounded-lg p-3">
              ...
              <div className="text-xl font-bold font-mono">{(safeConfidence * 100).toFixed(1)}%</div>
            ...
            <div className="bg-dark-bg border border-dark-border rounded-lg p-3">
              ...
              <div className="text-xl font-bold font-mono text-white">{(safePositionSize * 100).toFixed(1)}%</div>
